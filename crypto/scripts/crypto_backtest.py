...
class AdvancedPortfolioTracker:
    ...
    def _calculate_risk_metrics(self, returns, risk_free_rate=0.02):
        ...
        beta = 1.0  # Simplified - would need market correlation for accurate calculation
...
def run_crypto_backtest():
    """Run comprehensive backtest on all crypto assets."""
    # Initialize
    ist = pytz.timezone('Asia/Kolkata')
    start_time = datetime.now(ist)
    start_date, end_date = get_backtest_period()
    
    print("🚀 Enhanced Crypto Backtest Scanner")
    print("=" * 100)
    ...
    portfolio = AdvancedPortfolioTracker(initial_capital=10000)  # $10,000 starting capital
    ...
    print(f"⏱️  Position Size: $1,000 per trade")
    print("=" * 100)
