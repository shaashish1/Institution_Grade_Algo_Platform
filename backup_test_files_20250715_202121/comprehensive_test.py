...
def main():
    ...
    core_modules = [
        ("crypto.data_acquisition", "Crypto data fetching via CCXT"),
        ("stocks.data_acquisition", "Stock data fetching via Fyers API"),
    ...
    for module_name, description in core_modules:
        ...
        if success:
            ...
            if module_name in ["crypto.data_acquisition", "stocks.data_acquisition"]:
